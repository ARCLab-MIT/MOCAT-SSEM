...
function my_sim = drag_check(scen_properties, mass, radius, starting_altitude)
...
species_properties.sym_name = "TestSpecies";
...
species_properties.lambda_constant(find_alt_bin(starting_altitude, scen_properties)) = species_properties.lambda_constant(find_alt_bin(starting_altitude, scen_properties)) + 0.01*(500/5);
N_species = species(@launch_func_constant, @pmd_func_none,my_drag_func, species_properties, scen_properties);


scen_properties.species = N_species;
scen_properties.species_cell = struct('N', N_species);
