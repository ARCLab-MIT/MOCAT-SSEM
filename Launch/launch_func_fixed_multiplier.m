function [Lambdadot] = launch_func_fixed_multiplier(t, h, species_properties, scen_properties)
    ...
    Lambdadot = species_properties.lambda_multiplier .* ones(scen_properties.N_shell, 1, "sym") .* species_properties.sym(:);
