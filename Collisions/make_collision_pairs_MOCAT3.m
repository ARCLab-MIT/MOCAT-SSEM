function [scen_properties] = make_collision_pairs_MOCAT3(scen_properties, Su_species, D_species, N_species)
% This function is specific to MOCAT 3. The generalized function for other
...
for i = 1:height(species_pairs)
    ...
    % Make species_pair_class class with gammas and source_sinks
    species_pairs_classes(i) = species_pair_class(s1, s2, gammas, source_sinks, scen_properties);

    % Correct equations such that collisions between S&S, S&D, and D&D are
    % catastrophic instead of damaging
    if (n1 == "Su" || n1 == "D") && (n2 == "Su" || n2 == "D")
